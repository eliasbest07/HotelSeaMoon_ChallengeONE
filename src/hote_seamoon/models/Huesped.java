...
public class Huesped {
	...
	public Huesped(String nombre, String apellido,Integer numeroIdentidad , LocalDate fechaNacimiento, String nacionalidad, Long telefono, Integer numeroReserva) {
		this.nombre = nombre;
