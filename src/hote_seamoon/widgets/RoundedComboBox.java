...
public class RoundedComboBox extends JComboBox<String> {
    ...
    private class RoundedComboBoxUI extends BasicComboBoxUI {
        ...
        protected JButton createArrowButton() {
               ...
               ImageIcon icon = new ImageIcon(getClass().getResource("../assets/flecha.png"));
               arrowButton.setIcon(icon);
               return arrowButton;
            //return new RoundedButtonOpcion(10,new Color(255, 255, 255,100),new Color(255, 255, 255,255)) {
            //		@Override
            //		public void setIcon(Icon defaultIcon) {
            //			//defaultIcon = new ImageIcon(getClass().getResource("assets/flecha.png")
